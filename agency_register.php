...
<body>
    ...
    <form action="process.php" method="POST">
        <div class="heading fs-3">Car Rental Agency Registration</div>
        ...
        <input type="submit" value="Register" name="agency_register">
        <div class="for-click mt-4">Already agency? <a href="agency_login.php">Login</a></div>
        <div class="for-click mt-2">Continue as customer? <a href="customer_register.php">Customer</a></div>
